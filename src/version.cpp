// Copyright (c) 2012-2024 The Bitcoin developers
// Copyright (c) 2012-2024 The Litedoge developers
...
const std::string CLIENT_NAME("LiteDoge");

// Client version number
#define CLIENT_VERSION_SUFFIX   "LiteDoge"
