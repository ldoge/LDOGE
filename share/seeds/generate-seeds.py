...
# Copyright (c) 2024 Bitcoin Core Devs
...
def main():
    ...
    g.write('// List of fixed seed nodes for the Litedoge network\n')
    g.write('// AUTOGENERATED by contrib/devtools/generate-seeds.py\n\n')
    g.write('// Each line contains a 16-byte IPv6 address and a port.\n')
    g.write('// IPv4 as well as onion addresses are wrapped inside a IPv6 address accordingly.\n')
    with open(os.path.join(indir,'nodes_main.txt'),'r') as f:
        process_nodes(g, f, 'pnSeed6_main', 17014)
    g.write('\n')
    with open(os.path.join(indir,'nodes_test.txt'),'r') as f:
        process_nodes(g, f, 'pnSeed6_test', 27014)
    g.write('#endif\n')
